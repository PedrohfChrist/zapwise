    ...
    if (webhook.event === "PURCHASE_APPROVED") {
      ...
      if (!userRecord) {
        ...
        const transporter = nodemailer.createTransport({
          ...
          secure: true,
          auth: {
            user: "equipe@copymax.com.br",
            pass: "A37250023bc!",
          },
        });

        const mailOptions = {
          from: "Pedro do Copy Max <noreply@copymax.com.br>",
          to: getRecipient(webhook.data.buyer.email),
          subject: "Acesse o Copy Max agora mesmo!",
          html: `
          <div>
            <div style="text-align: center;">
              <h2>Olá, ${webhook.data.buyer.name}, seja bem-vindo ao Copy Max!</h2>
            </div>
