...
const emailCarrinhoAbandonadoFields = [
  {
    name: "name",
...
Crie uma copy envolvente e persuasiva para um email de recuperação de carrinho abandonado. O objetivo deste email é converter leads que assistiram ao vídeo de vendas, clicaram no botão de compra, inseriram suas informações no checkout, mas abandonaram sem finalizar a compra. Gere conexão e persuade o lead a finalizar a compra. Aqui estão os detalhes:
...
const EmailCarrinhoAbandonado = () => {
  const moduleType = "Email Carrinho Abandonado";

  return (
    <CopyModule
      moduleType={moduleType}
      fields={emailCarrinhoAbandonadoFields}
      promptTemplate={promptTemplate}
    />
  );
};

export default EmailCarrinhoAbandonado;
