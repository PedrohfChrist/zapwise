...
const url = "https://changepassword-sfveflcfxq-uc.a.run.app";
...
export default function Account({ rerender, setRerender }) {
  ...
  // Se o provedor for Google, não permitimos alteração de senha
  ...
  const changePassword = async (e) => {
    ...
    // Aqui você pode adicionar um tratamento de resposta para feedback
  };
    ...
    <div className="p-8 xl:w-3/5 mx-auto 2xl:w-1/3">
      ...
      <Card className="mt-8 w-full">
        <CardContent>
          ...
          {/* Use o operador de coalescência para garantir string vazia */}
